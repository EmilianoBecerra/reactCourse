        ...
        <div className="jumbotron">
          ...
          {mostrar && (
            <p className="alert alert-info">
              ...
              excepturi similique voluptatem itaque, eveniet nobis atque nemo
              veritatis quibusdam aliquam laudantium adipisci commodi pariatur.
              Voluptates est error cumque dolores?
            </p>
          )}
          ...
          <br />
          <h5>
            <u> Array de personas en una lista </u>
          </h5>
          <br />
          ...
          <h5>
            <u> Array de alumnos en una lista </u>
          </h5>
          <br />
          ...
          <h5>
            <u> Array de alumnos en una tabla estatica </u>
          </h5>
          <br />
