    ...
    return (
        <div className="CounterFunctional">
            <div className="jumbotron">
                ...
                <button className="btn btn-danger my-3 mr-3" onClick={ () => setCounter(counter - 1) }> Decrementar </button>
                <button className="btn btn-success my-3 " onClick={ () => setCounter(counter + 1) }> Incrementar </button>
            </div>
        </div>
    )
}
